...
hidden if the `events_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `events_DEVELOPER_MODE` to the configure
...
the directory where the vcpkg executable is.
